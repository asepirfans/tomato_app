...
class DataLoggerTabel2 extends StatelessWidget {
                      ...
                      child: DataTable(
                        ...
                        rows: data.map((datum) {
                          return DataRow(cells: [
                            ...
                            DataCell(Text(datum.plant2.suhu.toString())),
                            DataCell(
                                Text(datum.plant2.kelembapanTanah.toString())),
                            DataCell(Text(datum.plant2.keterangan.toString())),
                          ]);
                        }).toList(),
                      ),
                    ),
